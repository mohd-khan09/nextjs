...
const SearchBar: React.FC = () => {
  ...
  const [images, setImages] = useState([
    ...
    'https://dummyimage.com/100x100/111/fff',
    'https://dummyimage.com/100x100/222/fff',
    'https://dummyimage.com/100x100/333/fff',
    'https://dummyimage.com/100x100/444/fff',
    'https://dummyimage.com/100x100 /555/fff',
  ])
  ...
  return (
    ...
    {images.map((imageUrl, index) => (
      <GridElement key={index} imageUrl={imageUrl} index={index} />
    ))}
  </div> */}
    </div>
  )
